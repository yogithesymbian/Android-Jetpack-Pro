...
object DataDummy {
    ...
    fun generateDummyTvShow(): List<TvShowEntity> {
        ...
        arrListTvShow.add(
                TvShowEntity(
                        "a14",
                        "TVMenjadi Android Developer Expert",
        ...
        arrListTvShow.add(
                TvShowEntity(
                        "a55",
                        "TVKotlin Android Developer Expert",
        ...
        arrListTvShow.add(
                TvShowEntity(
                        "a47",
                        "TVMenjadi Game Developer Expert",
        ...
        arrListTvShow.add(
                TvShowEntity(
                        "a74",
                        "TVMembangun Progressive Web Apps",
        ...
        arrListTvShow.add(
                TvShowEntity(
                        "a51",
                        "TVBelajar Membuat Aplikasi Android untuk Pemula",
